...
model = Doc2Vec(all_texts_taggle, workers=num_workers, dm = 1,
            vector_size=num_features, min_count = min_word_count,
            window = context, seed=1)

print ("Saving Doc2Vec model...")
model.save("./d2v/d2v_all_text.model")
"""
...
#model.save('./model/deepbaseline_y1.hdf5')
#model.save('./model/deepbaseline_y2.hdf5')
#model.save('./model/deepbaseline_y3.hdf5')
#model.save('./model/deepbaseline_y4.hdf5')
#model.save('./model/deepbaseline_y5.hdf5')
model.save('./model/deepbaseline_y6.hdf5')
...
model1 = keras.models.load_model('./model/deepbaseline_y1.hdf5')
predictions1 = model1.predict_proba(d2v_test, verbose=0)

model2 = keras.models.load_model('./model/deepbaseline_y2.hdf5')
predictions2 = model1.predict_proba(d2v_test, verbose=0)

model3 = keras.models.load_model('./model/deepbaseline_y3.hdf5')
predictions3 = model1.predict_proba(d2v_test, verbose=0)

model4 = keras.models.load_model('./model/deepbaseline_y4.hdf5')
predictions4 = model1.predict_proba(d2v_test, verbose=0)

model5 = keras.models.load_model('./model/deepbaseline_y5.hdf5')
predictions5 = model1.predict_proba(d2v_test, verbose=0)

model6 = keras.models.load_model('./model/deepbaseline_y6.hdf5')
...
df.to_csv('./result/result_deep.csv')
